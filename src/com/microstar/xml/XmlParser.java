...

    ...
    throws java.lang.Exception
  {
    ...
    if (type == ATTRIBUTE_ENUMERATED || type == ATTRIBUTE_NOTATION) {
      enum_str = dataBufferToString();
    }

				// Read the default value.
    requireWhitespace();
    parseDefault(elementName, name, type, enum_str);
  }
  ...
  /**
    ...
    */
  void parseDefault (String elementName, String name, int type, String enum_str)
    throws java.lang.Exception
  {
    ...
    setAttribute(elementName, name, type, enum_str, value, valueType);
  }
