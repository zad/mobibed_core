 ...
 *
 */
public class SyncMobibedSocketEcho extends drcl.net.Module 
	...
	private static final int ECHO_PKT_LEN = 32;
...
//	}
	...
	public SyncMobibedSocketEcho(String id_){
		super(id_);
	}
...
//				System.out.println("recv "+System.nanoTime());
				...
				{
					// record current time
					if(server && ntest == 1)rtt = System.nanoTime();
					dataArriveAtUpPort(pkt, null);
				}
				else
				{
					System.out.println("end of echo test");
					if(server)System.out.println((System.nanoTime()-rtt)/9000000.0);
					break;
				}
