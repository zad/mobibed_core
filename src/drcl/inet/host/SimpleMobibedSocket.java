 ...
 *
 */
public class SimpleMobibedSocket extends drcl.net.Module 
...
//	}
	...
	public SimpleMobibedSocket(String id_){
		super(id_);
	}
...
//				len_ = 1400;
			DatagramPacket sendPacket = 
	                new DatagramPacket(ipkt_.getBytes(), 1024, remote_ip, remote_port);//, InetAddress.getByName("localhost"), ipkt_.getPort());
